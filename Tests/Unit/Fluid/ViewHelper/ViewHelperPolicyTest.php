...
#[CoversMethod(ViewHelperPolicy::class, 'fromIdentifiers')]
#[CoversMethod(ViewHelperPolicy::class, 'isAllowed')]
#[CoversMethod(ViewHelperPolicy::class, 'isNamespaceRelevant')]
#[CoversMethod(ViewHelperPolicy::class, 'getFingerprint')]
#[CoversMethod(ViewHelperPolicy::class, 'getIdentifiers')]
#[CoversMethod(ViewHelperPolicy::class, 'hasUnexpandableEntries')]
#[CoversMethod(ViewHelperPolicy::class, 'isEmpty')]
