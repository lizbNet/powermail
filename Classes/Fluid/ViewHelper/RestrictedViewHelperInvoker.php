 ...
 * never reaches invoke() - among them f:format.raw, f:then, f:else, f:case, f:defaultCase, f:switch,
 * f:argument, f:fragment, f:cache.disable, f:cache.static, f:section, f:comment and f:layout. The
 * resolver is what actually blocks those, because it prevents the node from being created at all.
 *
